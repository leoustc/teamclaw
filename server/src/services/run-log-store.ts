...
import { resolveTeamClawInstanceRoot } from "../home-paths.js";
...
export function getRunLogStore() {
  ...
  const basePath = process.env.RUN_LOG_BASE_PATH ?? path.resolve(resolveTeamClawInstanceRoot(), "data", "run-logs");

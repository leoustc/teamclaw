...
import { models as codexFallbackModels } from "@teamclawai/adapter-codex-local";
import { models as cursorFallbackModels } from "@teamclawai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@teamclawai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.TEAMCLAW_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.TEAMCLAW_OPENCODE_COMMAND = "__teamclaw_missing_opencode_command__";

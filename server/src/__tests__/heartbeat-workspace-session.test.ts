...
import { resolveDefaultCompanyWorkspaceDir, resolveLegacyCompanyWorkspaceDir } from "../home-paths.js";
import {
...
describe("resolveRuntimeSessionParamsForWorkspace", () => {
  it("migrates fallback workspace sessions to project workspace when project cwd becomes available", () => {
    ...
    const fallbackCwd = resolveDefaultCompanyWorkspaceDir(companyId);
  ...
  it("migrates legacy fallback workspace sessions to project workspace when project cwd becomes available", () => {
    const agentId = "agent-123";
    const companyId = "company-123";
    const legacyFallbackCwd = resolveLegacyCompanyWorkspaceDir(companyId);

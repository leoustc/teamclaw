# TeamClaw Create Agent API Reference
...
```json
{
  ...
  "adapterConfig": {
    ...
    "promptTemplate": "You are Architect..."
  },
  "runtimeConfig": {
    "heartbeat": {
      "enabled": true,
...
For local adapters, each agent should also have a local workspace under:
...
- examples: `manager_manager`, `architect_architect`, `engineer_alpha`
...
- After approval resolution, requester may be woken with `TEAMCLAW_APPROVAL_ID` and should reconcile linked issues.

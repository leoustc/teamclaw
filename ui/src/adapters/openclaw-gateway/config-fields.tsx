...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="TeamClaw API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
                  "teamclawApiUrl",
                  String(config.teamclawApiUrl ?? ""),
                )
              }
              onCommit={(v) => mark("adapterConfig", "teamclawApiUrl", v || undefined)}
              immediate
              className={inputClass}
              placeholder="https://teamclaw.example"
            />
          </Field>
          ...
          {sessionStrategy === "fixed" && (
            <Field label="Session key">
              <DraftInput
                value={eff("adapterConfig", "sessionKey", String(config.sessionKey ?? "teamclaw"))}
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. TeamClaw persists a device key during onboarding so pairing approvals

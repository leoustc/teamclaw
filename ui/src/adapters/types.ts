...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@teamclawai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@teamclawai/adapter-utils").TranscriptEntry[];

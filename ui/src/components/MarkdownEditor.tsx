...
import { buildProjectMentionHref, parseProjectMentionHref } from "@teamclawai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("teamclaw-project-mention-chip");
      ...
      link.classList.add("teamclaw-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative teamclaw-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("teamclaw-mdxeditor", !bordered && "teamclaw-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "teamclaw-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}

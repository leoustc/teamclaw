            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  We recommend letting your Manager handle agent setup — they know the
                  org structure and can configure reporting, permissions, and
                  adapters.
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskManager}>
                <Bot className="h-4 w-4 mr-2" />
                Ask the Manager to create a new agent
              </Button>

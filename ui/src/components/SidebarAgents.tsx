...
import type { Agent } from "@teamclawai/shared";
...
export function SidebarAgents({ collapsed = false }: { collapsed?: boolean }) {
      ...
      <CollapsibleContent>
        <div className="flex flex-col gap-0.5 mt-0.5">
          {visibleAgents.map((agent: Agent) => {
            ...
            return (
              ...
              >
                ...
                {!collapsed ? <span className="flex-1 truncate">{agent.name}</span> : null}
          ...
          >
            ...
            {!collapsed ? <span className="truncate">Add Agent</span> : null}
          </button>
        </div>
      </CollapsibleContent>
    </Collapsible>

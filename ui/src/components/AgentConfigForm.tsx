...
import { AGENT_ADAPTER_TYPES } from "@teamclawai/shared";
import type {
  Agent,
...
// Canonical type lives in @teamclawai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@teamclawai/adapter-utils";
import type { CreateConfigValues } from "@teamclawai/adapter-utils";
            ...
            <Field label="Working directory" hint={help.cwd}>
              <div className="flex items-center gap-2 rounded-md border border-border px-2.5 py-1.5">
                ...
                <DraftInput
                  ...
                  placeholder={isCreate ? (props.cwdPlaceholder ?? "/path/to/project") : "/path/to/project"}
                />
                <ChoosePathButton />
              </div>
            </Field>
...
const ENABLED_ADAPTER_TYPES = new Set(["claude_local", "codex_local", "opencode_local", "oca_local", "cline_local", "cursor"]);
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        TEAMCLAW_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}

...
function isGitHubRepoRemote(value: string): boolean {
...
const projectWorkspaceFields = {
  ...
  repoUrl: z.string().trim().refine(isGitHubRepoRemote, "Must be a valid GitHub HTTPS or SSH remote").optional().nullable(),

...
export type AdapterIssueProposedStatus =
  | "todo"
  | "in_progress"
  | "in_review"
  | "blocked"
...
export interface AdapterIssueHandoff {
  issueId?: string | null;
  issueIdentifier?: string | null;
  proposedStatus?: AdapterIssueProposedStatus | null;
...
export interface AdapterExecutionResult {
  ...
  costUsd?: number | null;
  issueHandoff?: AdapterIssueHandoff | null;
  issueHandoffs?: AdapterIssueHandoff[] | null;

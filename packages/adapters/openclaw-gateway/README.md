...
This document describes how `@teamclawai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol as part of the TeamClaw human-plus-agent ticketing workflow.
...
5. stream `event agent` frames into TeamClaw logs/transcript parsing
